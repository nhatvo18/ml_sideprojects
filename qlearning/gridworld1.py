...
This python code generates Gridworld One from Assignment 4.
...
This code generates a 2D grid environment with cliffs at the bottom.
"""
...
class Environment:
    ...
    def _build_rewards(self):
        ...
        R[self.Ny - 1, 0, self.action_dict["right"]] = r_cliff
        for i in range (1, self.Nx - 1):
            R[self.Ny - 2, i, self.action_dict["down"]] = r_cliff
